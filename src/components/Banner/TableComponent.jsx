...
const TableComponent = ({ coins }) => {
  return (
    <BootstrapTable data={coins} striped hover>
      ...
      <TableHeaderColumn dataField="name">Price</TableHeaderColumn>
      <TableHeaderColumn dataField="price">24h Volume Change</TableHeaderColumn>
      <TableHeaderColumn dataField="price">Market Cap</TableHeaderColumn>
    </BootstrapTable>
  );
};
